<html>
<head>
<title>Evaluation of Resumes for the post of Freelancers</title>
...
<%if trim(request("message"))="sesexp" then
	Response.Write ("<font color='red'><b>Session expired, please login again</b></font>")
elseif trim(request("message"))="invalid" then
	Response.Write ("<font color='red'><b>Invalid login</b></font>")
elseif trim(request("message"))="err" then
	Response.Write ("<font color='red'><b>Please check Invalid Username or password.</b></font>")
end if%>
</td></tr>
</table>
<table border="1" width="50%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%"><form method="POST" action="checkuser.asp" align="center" onSubmit="return Validate(this)">
      <div align="center"><center><table border="0" width="100%" cellspacing="0" cellpadding="0" height="84">
        <tr>
          <td width="100%" bgcolor="#005563" height="21" colspan="3"><div align="center"><center><p><font face="verdana" size="1"  
          color="#FFFFFF"><big><strong>BizAcumen Research Freelancers Evaluation</strong></big></font></td>
        </tr>
        <tr align="center">
          <td width="100%" height="21" colspan="3"></td>
        </tr>
        <tr align="center">
          <td width="100%" height="21" colspan="3"><div align="center"><center><p><font face="verdana" size="2"  
        ...
        <tr align="center">
          <td width="34%" height="21" align="right"><div align="right"><p><strong><font face="verdana"  size="2" 
