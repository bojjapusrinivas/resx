...
<table border="1" width="95%" bordercolor="#005563" cellspacing="0" cellpadding="0" style="border-collapse:collapse;"> 
 <tr>
  ...
  <tr>
	...
	<tr>
<td colspan="7" align="center"><b>Search In :</b> <input type="radio" value="Bizacumen" checked name="Applicationfor" >Hyderabad &nbsp;&nbsp;&nbsp; <input type="radio" value="Gurgaon" name="Applicationfor" >Gurgaon</td></tr>
