...
if (trim(request("stat"))<>"" and trim(request("emailid"))<>"") then
	...
	if loadedval=2 then
		...
		call sendemail1(TOemailID,useremail,"Your SIS Infotech Application details",mysubject)	
	 End if
	Response.Redirect ("FRM_SIS_final_Print.asp?Message="&loadedval&"")
End if
%>
<html>
<head>
...
function submitval(actval)
{
	...
	if (updateval==true)
	{
		...
		window.frmsis.action="FRM_SIS_final_Print.asp";
...
<table border="1" width="95%" bordercolor="#005563" cellspacing="0" cellpadding="0" style="border-collapse:collapse;"> 
 <tr>
    <td width="100%" bgcolor="#005563"><p align="center"><strong><big><font color="#FFFFFF">Viewed Requests</font></big></strong></td>
  </tr>
  ...
  <tr>
	...
	<%	dim TStat
  	...
  	%>
  <tr>
		<td align="center" width="95%" bgcolor="#ffffff"><!--font face="verdana" size="2"><a href="FRM_SIS_final_Print.asp?ttype=1"><font face="verdana" size="2"><b>Pending</b></font></a> |--> <font face="verdana" size="2"><a href="FRM_SIS_final_Print.asp?ttype=2"><font face="verdana" size="2"><b>Approved</b></font></a> | <a href="FRM_SIS_final_Print.asp?ttype=3"><font face="verdana" size="2"><b>Declined</b></font></a>  | <a href="FRM_SIS_final_Print.asp?ttype=5"><font face="verdana" size="2"><b>Hold</b></font></a> | <font face="verdana" size="2"><a href="FRM_SIS_final_Print.asp?ttype=4"><font face="verdana" size="2"><b>Sent</b></font></a><!-- | <font face="verdana" size="2"><a href="FRM_SIS_final_Print.asp?ttype=0"><font face="verdana" size="2"><b>ALL</b></font></a--></td>
		</td>
	</tr>
  <tr>
	...
	<tr>
		...
		if trim(TStat)="4"  then		
			usql1="select * from TBL_SIS_Analysts where admin_status=2 order by rec_id"
		elseif trim(TStat)="0"  then
			usql1="select * from TBL_SIS_Analysts where rec_id>109 order by rec_id"
		else
			usql1="select * from TBL_SIS_Analysts where rec_id>109 and user_status="&TStat&" order by rec_id"
		end if
		rsDisp.Open usql1
		''paging
		'rsDisp.movefirst
		...
		if i>cint(rec_per_page) then
			...
			for i=1 to rsDisp.PageCount%>			
				<a href="FRM_SIS_final_Print.asp?Start=<%=Start%>&amp;E=<%=E%>&amp;Cp=<%=i%>&ttype=<%=trim(request("ttype"))%>"><%=i%></a>			
		...
		IF not rsDisp.EOF THEN					
			...
			while not rsDisp.EOF and rowcount<rsDisp.PageSize
				...
				Response.Write ("<tr bgcolor='white'>")					
					...
					'			Response.Write ("<td align='center'><a href='javascript:OpenWin("& rsDisp("Rec_id") &");'><font face='verdana' size='2'>View</font></a> | <a href='FRM_SIS_Evaluation.asp?stat=A&RecID="&rsDisp("Rec_id")&"&emailid="&rsDisp("User_Email")&"'><font face='verdana' size='2'>Accept</font></a> | <a href='FRM_SIS_Evaluation.asp?stat=D&RecID="&rsDisp("Rec_id")&"&emailid="&rsDisp("User_Email")&"'><font face='verdana' size='2'>Decline</font></a></td>")
					'		elseif trim(rsDisp("User_Status"))="2" then
					'			Response.Write ("<td align='center'><a href='javascript:OpenWin("& rsDisp("Rec_id") &");'><font face='verdana' size='2'>View</font></a> | <a href='FRM_SIS_final_Print.asp?actstat="&rsDisp("User_status")&"&stat=A&RecID="&rsDisp("Rec_id")&"&emailid="&rsDisp("User_Email")&"'><font face='verdana' size='2'>Email</font></a></td>")
					'		elseif trim(rsDisp("User_Status"))="3" then
					'			Response.Write ("<td align='center'><a href='javascript:OpenWin("& rsDisp("Rec_id") &");'><font face='verdana' size='2'>View</font></a> | <a href='FRM_SIS_final_Print.asp?actstat="&rsDisp("User_status")&"&stat=D&RecID="&rsDisp("Rec_id")&"&emailid="&rsDisp("User_Email")&"'><font face='verdana' size='2'>Email</font></a></td>")
					'		elseif trim(rsDisp("User_Status"))="5" then
					'			Response.Write ("<td align='center'><a href='javascript:OpenWin("& rsDisp("Rec_id") &");'><font face='verdana' size='2'>View</font></a> | <a href='FRM_SIS_final_Print.asp?actstat="&rsDisp("User_status")&"&stat=H&RecID="&rsDisp("Rec_id")&"&emailid="&rsDisp("User_Email")&"'><font face='verdana' size='2'>Email</font></a></td>")
					'		end if
					'	else
					'		Response.Write ("<td align='center'><a href='javascript:OpenWin("& rsDisp("Rec_id") &");'><font face='verdana' size='2'>View</font></a> | <a href='FRM_SIS_final_Print.asp?actstat="&rsDisp("User_status")&"&stat=D&RecID="&rsDisp("Rec_id")&"&emailid="&rsDisp("User_Email")&"'><font face='verdana' size='2'>Re-send Email</font></a></td>")
					'	end if
					'end if
				Response.Write ("</tr>")
				j=j+1
