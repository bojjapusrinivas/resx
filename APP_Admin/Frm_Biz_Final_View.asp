...
<table border="1" width="95%" bordercolor="#005563" cellspacing="0" cellpadding="0" style="border-collapse:collapse;"> 
 <tr>
    <td width="100%" bgcolor="#005563"><p align="center"><strong><big><font color="#FFFFFF">Viewed Requests <%=ttypName%></font></big></strong></td>
  </tr>
  ...
  <tr>
	...
	<%	dim TStat
  	...
  	%>
  <tr>
		<td align="center" width="95%" bgcolor="#ffffff" height="20"><!--font face="verdana" size="2"><a href="Frm_SIS_Final_View.asp?ttype=1"><font face="verdana" size="2"><b>Pending</b></font></a> |--> <font face="verdana" size="2"><a href="Frm_biz_Final_View.asp?ttype=2"><font face="verdana" size="2"><b>Approved</b></font></a> | <a href="Frm_biz_Final_View.asp?ttype=3"><font face="verdana" size="2"><b>Declined</b></font></a>  | <a href="Frm_biz_Final_View.asp?ttype=5"><font face="verdana" size="2"><b>Hold</b></font></a> | <font face="verdana" size="2"><a href="Frm_biz_Final_View.asp?ttype=4"><font face="verdana" size="2"><b>Sent</b></font></a> | <a href="Frm_biz_Final_View.asp?ttype=6"><font face="verdana" size="2"><b>Test Taken</b></font></a>| <a href="Frm_biz_Final_View.asp?ttype=8"><font face="verdana" size="2"><b>Block</b></font></a> 
...
<%if trim(request("ttype")) ="2" then%>
	<a href="Frm_biz_Final_View.asp?ttype=2&ppost=1"><font face="verdana" size="2"><b>Research Position</b></font></a> | <a href="Frm_biz_Final_View.asp?ttype=2&ppost=2"><font face="verdana" size="2"><b>QC Team</b></font></a> | <a href="Frm_biz_Final_View.asp?ttype=2&ppost=3"><font face="verdana" size="2"><b>Content Development</b></font></a> | <a href="Frm_biz_Final_View.asp?ttype=2&ppost=4"><font face="verdana" size="2"><b>Data Entry</b></font></a> | <a href="Frm_biz_Final_View.asp?ttype=2&ppost=5"><font face="verdana" size="2"><b>DTP</b></font></a><br>
<%end if%>
</td>
</tr>
  ...
  <tr>
	...
	<tr>
		...
		if trim(TStat)="4"  then		
			usql1="select * from TBL_SIS_Applications where user_status=2  order by rec_id"
		elseif trim(TStat)="0"  then
			usql1="select * from TBL_SIS_Applications where rec_id >10420  order by Date_Created desc"  '9541
		elseif trim(TStat)="6"  then
			usql1="select * from TBL_SIS_Applications where ANA_No <> '' order by Date_Created desc"
		else
			usql1="select * from TBL_SIS_Applications where user_status="&TStat& PostName &" and ANA_no is null and rec_id>10420 order by rec_id"
		end if
