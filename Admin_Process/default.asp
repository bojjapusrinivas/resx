...
''i = +12.5
''r = h + i
'Response.write GoToSunday(date)
'response.write time
''response.write(IPAddressCheck())
''Response.write((FormatDateTime(now(),2) &  " 5:00:00 AM") =now())
''Response.write((FormatDateTime(now(),2) &  " 5:00:00 AM") & "<br>") 
''Response.write now() 
%>
</td></tr>
</table>
  ...
  <tr>
    <td width="100%"><form method="POST" action="checkuser.asp" align="center" onSubmit="return Validate(this)">
      <div align="center"><center><table border="0" width="100%" cellspacing="0" cellpadding="0" height="84">
        <tr>
          <td width="100%" bgcolor="#13426E" height="21" colspan="3"><div align="center"><center><p><font
