...
<table border="1" width="95%" bordercolor="#005563" cellspacing="0" cellpadding="0" style="border-collapse:collapse;"> 
 <tr>
  ...
  <tr>
	...
	<tr>
<td colspan="7" align="center"><b>Search In :</b> <!--input type="radio" value="Hyderabad" checked name="Applicationfor" >Hyderabad &nbsp;&nbsp;&nbsp; <input type="radio" value="Gurgaon" name="Applicationfor" >Gurgaon-->&nbsp;&nbsp;&nbsp; <input type="radio" checked value="BizAcumen" name="Applicationfor" >BizAcumen&nbsp;&nbsp;&nbsp; <input type="radio" value="Campus" name="Applicationfor" >Campus</td></tr>
...
<td colspan="7">  <div align="center"><center><p><font color="#004080"><strong>Candidate Surname :</strong></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="text" name="txtSurname" value="<%=Request("txtSurname")%>" size="25"></p>
          </center></div> </td>
...
<td colspan="7">  <div align="center"><center><p><input type="submit" value="Enter" name="Btn1"></p>
	...
	<tr>
		...
		if trim(request("ID"))<>"" or trim(request("candPhone")) <> "" or trim(request("txtSurname")) <> "" Or trim(request("candemail")) <> "" Or trim(request("txtSplSkils"))<>"" then		
			...
			'else
				usql1="select * from TBL_SIS_Applications where user_status not in (0,7,8,9) and Applicationfor='" & trim(request("Applicationfor")) & "'" &   whrcnd & " order by user_name"
			'end if
