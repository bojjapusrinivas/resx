...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" id="form_table">
  <tr>
          <td><h6 class="fmedium">Please tell us about yourself, your family, interests, special skills, hobbies, and anything that would enable us to know more about you as a person. Minimum number of words for qualifying the screening process is 500 (3500 characters). Please note we are mainly looking for quality English expression in your write-up. Maximum number of words can go up to 1000 (7000 characters). The following write-up submitted by you will be the primary basis for selection in our team.<span class="red"> *You are requested NOT to paste your resume in the following box. Pasting your resume here will automatically disqualify you from our recruitment process.</span></h6></td>
          </tr>
  <tr>
...
<h6 style="text-align:center; font-size:12px">Thanks for applying. We will inform you of our decision shortly.<br/>
