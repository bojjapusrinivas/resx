...
<!-- Bootstrap core CSS -->
<link href="Multiselect/bootstrap.css" rel="stylesheet">
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
<script src="Multiselect/bootstrap.min.carousel.support.js"></script>
        ...
        $('#ddlLocation').multiselect({  
         ...
         <div class="row">
			...
			<?php   $sCompany ="";
				...
				{
				if (($_POST['ddlDesignation']<>"")||($_POST['ddlDomain']<>"")||($_POST['ddlCompany']<>"")||($_POST['ddlLocation']<>"")||($_POST['find']<>""))
				{    

				        
					$aCompany= $_POST["ddlCompany"]; 
					foreach ($aCompany as $value)
						...
						$sCompany  = $sCompany. "'";
                                        ...
                                        $aDesignation= $_POST['ddlDesignation']; 
					...
					if ($_POST['ddlLocation']<>"")
					{
						$WhereCluase .= " and Location like ('%".$_POST['ddlLocation']."%')";
					}
					if ($_POST['find']<>"")
					{
					...
					//echo $_POST['ddlDomain']."<br>";
					//echo $_POST['Company']."<br>";
					//echo $_POST['ddlLocation']."<br>";
					//echo $_POST['find'];
			...
			<form class="form-horizontal" action="Searchmulti.php" method="post" style="width:100%" name="search">
			<!-- Form Elements -->
                <div>
                  <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                             <select class="form-control" name="ddlCompanyType[]" id="ddlCompanyType" multiple="multiple" class=" form-control"><option value="Public">Public</option><option value="Private">Private</option></select>
                          </div>
                        </div>
                       <div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                                 <select name="ddlDesignation[]" id="ddlDesignation" multiple="multiple" class="form-control" >
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <select name="ddlCompany[]" id="ddlCompany" multiple="multiple"  class=" form-control">
						...
						<div class="form-group row">
                          ...
                          <div class="col-sm-10">
                           <select name="ddlLocation" id="ddlLocation" multiple="multiple" class="form-control">
                        ...
                        <div class="line"></div>
						<div class="form-group row">
                          <label class="col-sm-2 form-control-label">Free Text Search</label>
                          <div class="col-sm-10">
