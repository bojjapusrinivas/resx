...
if trim(request("butnvalue"))<>"" then
	...
	if trim(request("SelStatus")) <> "" then
	  admstats=trim(request("SelStatus"))
      	...
      	if trim(lcase(request("butnvalue")))="accept1" then
			...
			insertval = 2
			sqlupdate="update TBL_SIS_Applications set user_status=2, User_Points="&trim(userrank)&",Reason_Update='" & mystat1 & "',updated_by='" & trim(session("user_name")) & "',Date_Updated=getdate() where Rec_ID="&trim(request("ID"))&""
	...
	elseif trim(lcase(request("butnvalue")))="accept2" then
      	...
      	elseif trim(lcase(request("butnvalue")))="decline" then
			Mystat = "Decline"
			mystat1 = "Declined " & trim(request("txtreason"))
			userrank=0
			userrank1=0
			insertval = 3
			sqlupdate="update TBL_SIS_Applications set user_status=3, User_Points="&trim(userrank)&",Reason_Update='" & mystat1 & "',updated_by='" & trim(session("user_name")) & "',Date_Updated=getdate() where Rec_ID="&trim(request("ID"))&""
	...
	'	response.end
		...
		dim x
		x = cint(Request("ID"))+1
		response.redirect ("AnAApplicantIntinfo.asp?ID="&trim(Request("ID"))&"&SUB=1#callID1")
end if
%>
<html>
<head>
...
function submitval(actval,recID)
{
	...
	//{
		...
		window.frmsis.action="AnAApplicantIntinfo.asp?ID="+recID+"&butnvalue="+actval;
...
if trim(Request("ID"))<>"" then
	'SQL = "SELECT *,dbo.ReturnAppearedHydDetails(a.Rec_id) as appeared FROM TBL_SIS_Applications a ,Interview_Gurgaon_Details b  where a.Rec_id =b.Rec_id and testwriteupdate>='6/10/2007' and a.Rec_ID="&trim(Request("ID")) & ""
	SQL = "SELECT *,dbo.ReturnAppearedHydDetails(b.Rec_id) as appeared FROM TBL_SIS_Applications a ,Interview_Hyd_Details b where a.Rec_id =b.Rec_id and a.Rec_ID="&trim(Request("ID")) & ""
else
	'SQL = "SELECT *,dbo.ReturnAppearedDetails(Rec_id) as appeared FROM TBL_SIS_Analysts_Gurgaon where  user_name like ('%"&trim(Request("candname"))&"%')"
...
<table border="0" width="90%" cellspacing="0" cellpadding="0" bordercolor="#000080" class=mystyle>
  <tr>
    <td width="100%"><div align="center"><center><table border="1" width="100%" 
...
%>
	...
	<%if trim(session("user_type")) ="4" or trim(session("user_type")) ="2"  then%>
      <tr align="center">
	  ...
	  <tr>
          ...
          <tr>
            ...
            <td width="4%" align="center" height="1"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="79%" height="1"><font face="verdana" size="2" color="#004080"><%=rs("SurName")%>&nbsp;<%=rs("user_Name")%></td>
          </tr>
	  <tr>
	...
	<%if session("user_name")="aneesa" or trim(session("user_type")) ="4" then %>
          <tr>
	...
	<tr align="center">
        ...
        <table border="0" width="98%" bordercolor="#800000" cellspacing="0" cellpadding="3">
          <tr>
            ...
            <td width="5%" align="center" height="21"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("Interviewewer")%>
	    </td>
          </tr>
	  <tr>
            <td width="36%" height="21"><font face="verdana" size="2" color="#004080">Personality</font></td>
            <td width="5%" align="center" height="21"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("Personality")%>
	    </td>
          </tr>
	  <tr>
            ...
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("AboutFamily")%>
	    </td>
          </tr>
	  <tr>
            <td width="36%" height="21"><font face="verdana" size="2" color="#004080">Resident of</font></td>
            <td width="5%" align="center" height="21"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("Residentof")%>
	    </td>
          </tr>
	  <tr>
            <td width="36%" height="21"><font face="verdana" size="2" color="#004080">Spoken English</font></td>
            <td width="5%" align="center" height="21"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("SpokenEnglish")%>
	    </td>
          </tr>
	  <tr>
            <td width="36%" height="21"><font face="verdana" size="2" color="#004080">Dress Code </font></td>
            <td width="5%" align="center" height="21"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("DressCode")%>
	    </td>
          </tr>
	   <tr>
            <td width="36%" height="21"><font face="verdana" size="2" color="#004080">Experience Company </font></td>
            <td width="5%" align="center" height="21"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("Company")%>
	    </td>
          </tr>
	  <tr>
            <td width="36%" height="21"><font face="verdana" size="2" color="#004080">Years </font></td>
            <td width="5%" align="center" height="21"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("Years")%>
	    </td>
          </tr>
	  <tr>
            <td width="36%" height="21"><font face="verdana" size="2" color="#004080">Salary </font></td>
            <td width="5%" align="center" height="21"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("Salary")%>
	    </td>
          </tr>
	  <tr>
            <td width="36%" height="21" valign="top"><font face="verdana" size="2" color="#004080">Other Info</font></td>
            <td width="5%" align="center" height="21" valign="top"><font face="verdana" size="2" color="#004080"><strong>:</strong></font></td>
            <td width="59%" height="21"><font face="verdana" size="2" color="#008080"><%=rs("Otherinfo")%>
	    </td>
          </tr>
        </table>
        </center></div></td>
...
<tr align="center">
	  ...
	  <tr>
            <td width="100%"><font face="verdana" size="2" color="#004080">Appeared/Not Appeared :</font><font face="verdana" size="2" color="#008080"><%if trim(rs("appeared")) <>"" then Response.write(" Appeared") else Response.write(" Not Appeared") end if%></font></td>
          </tr>
	  <tr>
            <td width="100%"><font face="verdana" size="2" color="#004080">Resume & Photograph :</font><font face="verdana" size="2" color="#008080"><%if trim(rs("appeared")) <>"" then Response.write(trim(rs("appeared"))) else Response.write(" ") end if%></font></td>
          </tr>
          <tr>
...
<%'response.write ("for testing" & rs("ANA_No"))
'response.end %>
	  <tr>
            <td width="100%"><font face="verdana" size="2" color="#004080">IGMs Rank1 :</font>
<%
'Response.write isnull(trim(rs("User_Points"))) 
if (isnull(trim(rs("User_Points")))=true and (trim(rs("User_Status"))="11")) then%> <select name="UserRank">
...
<tr align="center">
        <a name="callID1"><td width="100%" height="1" bgcolor="#D3E1DF"><p align="left"><big><font face="verdana" size="2" color="#804040"><strong>&nbsp;&nbsp;
        Candidate Status:</strong></font></big></td></a>
      </tr>
    <tr><td>
...
<tr align="center">
		...
		if trim(session("user_type")) = "4" then
			...
			Response.Write ("<td colspan=7 align=left><input type=""button"" name=""butnvalue"" value=""IGMs Accept"" onclick=""javascript:submitval('Accept1','"&rs("Rec_ID")&"')"">&nbsp;&nbsp;&nbsp;<input type=""button"" name=""butnvalue"" value=""RR Accept"" onclick=""javascript:submitval('Accept2','"&rs("Rec_ID")&"')"">&nbsp;&nbsp;&nbsp;<input type=""button"" name=""butnvalue"" value=""Reject"" onclick=""javascript:submitval('Decline','"&rs("Rec_ID")&"');"">&nbsp;&nbsp;&nbsp;<input type=""button"" name=""butnvalue"" value=""Hold"" onclick=""javascript:submitval('Hold','"&rs("Rec_ID")&"');""></td>")	
			'end if
			
		else
			'Response.write (trim(session("user_type")) & "   jkljjkljljljljljlj")
			if (isnull(trim(rs("User_Points")))=true) and trim(rs("User_Status"))="2" or trim(rs("User_Status"))="5" or trim(rs("User_Status"))="11"  then
			   if trim(rs("appeared")) ="Both" then
				Response.Write ("<td colspan=7 align=left><input type=""button"" name=""butnvalue"" value=""IGMs Accept"" onclick=""javascript:submitval('Accept1','"&rs("Rec_ID")&"')"">&nbsp;&nbsp;&nbsp;<input type=""button"" name=""butnvalue"" value=""Reject"" onclick=""javascript:submitval('Decline','"&rs("Rec_ID")&"');"">&nbsp;&nbsp;&nbsp;<input type=""button"" name=""butnvalue"" value=""Hold"" onclick=""javascript:submitval('Hold','"&rs("Rec_ID")&"');""></td>")	
			   end if
			end if
