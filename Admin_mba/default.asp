  ...
  <tr>
    <td width="100%"><form method="POST" action="checkuser.asp" align="center" onSubmit="return Validate(this)">
      <div align="center"><center><table border="0" width="100%" cellspacing="0" cellpadding="0" height="84">
        <tr>
          <td width="100%" bgcolor="#005563" height="21" colspan="3"><div align="center"><center><p><font
          color="#FFFFFF"><big><strong>BizAcumen Hyderabad Application Evaluation</strong></big></font></td>
        </tr>
        <tr align="center">
